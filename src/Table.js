...
function Table() {
    ...
    return (
        <>
            <table id="table" className='center' style="text-align: center; width:50%;">
                <tr>
                    <td id="ph1" onclick=""></td>
                    <td id="ph2"></td>
                    <td id="a1"></td>
                    <td id="ph3"></td>
                </tr>
            ...
            <input id="userInput" type="text" value="" placeholder="Any # between 30 - 100" />
            <button id="gobutton" onclick={buttonClicked} class="btn btn-primary">Go!</button>
        </>
    )
}
